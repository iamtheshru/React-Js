...
const ChairAllDetails = () => {
    ...
    const data = async (productId, newQuantity) => {
        const res = await fetch(`http://localhost:4000/ChairData/${productId}`);
    ...
    const fetchProductDetails = async () => {
        try {
            const response = await fetch(`http://localhost:4000/ChairData/${id}`);
...
export default ChairAllDetails;