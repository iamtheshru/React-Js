                ...
                {state ? <>
                    <form onSubmit={Submit1}>
                        <div class="form1 sign-in col-70">
                            <h2 className="lgn-text1">Welcome</h2>
                            <label className="fnt">
                                <span>Name</span>
                                <input type="text" className="lng-input1" value={inp1.name1} name="name1" onChange={handleChange1} onBlur={handleChange1} required />
                                {error1.name1Error ? <span>This field is Required</span> : ""}
                            </label>
                            <label className="fnt">
                                <span>Password</span>
                                <input type="password" className="lng-input1" value={inp1.password1} name="password1" onChange={handleChange1} onBlur={handleChange1} required />
                    ...
                    <form onSubmit={Submit2}>
                        <div class="form1 sign-up col-70">
                            <h2 className="lgn-text1">Create your Account</h2>
                            <label className="fnt">
                                <span>Name</span>
                            ...
                            <div className="btn1">
                                ...
                                <button onClick={data} className="submit1 lg-btn1">Sign In</button>
                            </div>
                            <div className="btn1">
                                <p>{message2}</p>
                            </div>
